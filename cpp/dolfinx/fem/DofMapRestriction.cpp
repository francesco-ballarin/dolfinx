...
//-----------------------------------------------------------------------------
void DofMapRestriction::_compute_cell_dofs(std::shared_ptr<const dolfinx::fem::DofMap> dofmap)
{
  ...
  {
    const auto unrestricted_cell_dofs_c = MDSPAN_IMPL_STANDARD_NAMESPACE::submdspan(
